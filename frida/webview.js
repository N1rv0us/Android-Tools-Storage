...
if (Java.available) {
    Java.perform(() => {
        ...
        const webview = Java.use("com.baidu.webkit.sdk.WebView");
        ...
        webview.setWebViewClient.implementation = function(client) {
            ...
            client.shouldOverrideUrlLoading.overload('com.baidu.webkit.sdk.WebView','com.baidu.webkit.sdk.WebResourceRequest').implementation = function(webview,request) {   
