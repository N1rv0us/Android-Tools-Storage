...
*/
    ...
    private static String getProcessNameByPid(int pid) throws IOException {
        // find ProcessName via pid  <- /proc/{pid}/cmdline
    ...
    public static void main(String[] args)  {
        ...
        {
            /*
             * The way Dumpall is implemented is to get the list of all registered services in the device by getService, 
             * and then dump each element of the list
             */
    ...
    private static String[] getServices() {
        /*
         * Reflact Invoke the listService method in the ServiceManager to get the service list.
         */ 
    ...
    private static List<ServiceUsage> getServiceUsage(String arg) {
        ...
        try {
            ...
            binder = ServiceManager.getService(arg);
