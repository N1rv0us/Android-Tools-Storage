...
class M2MTracer:
    ...
    def _is_intercept(self,target):
        ...
        for item_method in self.intercept_methods:
            if item_method.get_class_name() == tmp_cls or \
...
if __name__ == "__main__":
    ...
    st_cls = "Lcom/example/JavaScriptInterface/DemoJavaScriptInterface;"
    st_method = "loadUrl"
    st_descriptor = "(Ljava/lang/String;)V"

    ed_cls = "Landroid/webkit/WebView;"
    ed_method = "loadUrl"
    ed_descriptor = "(Ljava/lang/String;)V"
